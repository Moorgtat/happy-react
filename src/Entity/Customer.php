...
class Customer
{
     ...
     * @Assert\Length(
     *  min=2, 
     *  minMessage="Le prénom doit comporter un minimum de 2 caractères",
     *  max=50,
     *  maxMessage="Le prénom doit comporterau maximum 50 caractères")
     */
    private $firstName;
     ...
     * @Assert\Length(
     *  min=2, 
     *  minMessage="Le nom doit comporter un minimum de 2 caractères",
     *  max=50,
    ...
    /**
     * Permet de recupérer le montant total des factures
     * @Groups({"customers_read"})
     * @return float
     */
    public function getTotalAmount(): float
    {
     ...
     /**
     * Permet de recupérer le montant total du
     * @Groups({"customers_read"})
     * @return float
     */
